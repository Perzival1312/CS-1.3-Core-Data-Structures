...
class LinkedList(object):
    ...
    def length(self):
        ...
        Best and worst case running time: O(1) just returns a property"""
        return self.size
    ...
    def append(self, item):
        ...
        Best and worst case running time: O(1) just changing var values"""
    ...
    def delete(self, item):
        ...
        Best case running time: O(1) item is head
        Worst case running time: O(n) item is tail or DNE"""
        # Start at the head node
        node = self.head
